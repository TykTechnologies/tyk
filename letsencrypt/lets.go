...
import (
	...
	acme "github.com/go-acme/lego/v4/registration"
...
func (s *state) GetRegistration() *registration.Resource { return s.Reg }
...
func (m *Manager) registered() bool {
	return m.state.Reg != nil && m.state.Reg.Body.TermsOfServiceAgreed
}
