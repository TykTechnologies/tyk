...
func TestClassifyAuthError(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			source:       "AuthKey",
			expectedFlag: AKI,
			expectedDet:  "auth_key_not_found",
		},
		{
			name:         "cert_not_found",
			...
			source:       "AuthKey",
			expectedFlag: AKI,
			expectedDet:  "auth_cert_not_found",
		},
		{
			name:         "key_is_invalid",
			...
			source:       "AuthKey",
			expectedFlag: AKI,
			expectedDet:  "auth_key_is_invalid",
		},
		{
			name:         "cert_expired",
		...
		},
		{
			...
			source:       "AuthKey",
			expectedFlag: CRQ,
			expectedDet:  "auth_cert_required",
		},
		{
			name:         "cert_mismatch",
			...
			source:       "AuthKey",
			expectedFlag: CMM,
			expectedDet:  "auth_cert_mismatch",
		},
		// OAuth errors
		{
