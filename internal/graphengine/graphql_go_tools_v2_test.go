...
func TestGraphqlRequestProcessorV2_ProcessRequest(t *testing.T) {
...
func newTestGraphqlRequestProcessorV2(t *testing.T) *graphqlRequestProcessorV2 {
	gqlTools := graphqlGoToolsV2{}
	parsedSchema, err := gqlTools.parseSchema(testSchemaEngineV1)
	require.NoError(t, err)

	return &graphqlRequestProcessorV2{
