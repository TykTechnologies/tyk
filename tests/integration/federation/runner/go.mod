// Module for the in-process Tyk federation harness binary. This is a
// separate module so the parent Tyk module's `go build ./...` does not
// drag in gateway.StartTest (a test-time helper exposed in
// gateway/testutil.go) into production builds.
//
// The replace directive points at ../../../.. so `go build` here reads
// the gateway package straight from the working tree.
module github.com/TykTechnologies/tyk/tests/integration/federation/runner

go 1.25.0

require github.com/TykTechnologies/tyk v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/TykTechnologies/gorpc v0.0.0-20250214161245-e9f3f088e8c6 // indirect
	github.com/TykTechnologies/goverify v0.0.0-20260203113354-7a104729566e // indirect
	github.com/TykTechnologies/graphql-go-tools v1.6.2-0.20251104074758-abfe5c458f3b // indirect
	github.com/TykTechnologies/graphql-go-tools/v2 v2.0.0-20260508193952-83c21e0fb41a // indirect
	github.com/TykTechnologies/graphql-translator v0.0.0-20250602105400-41c2e7514a36 // indirect
	...
	github.com/TykTechnologies/opentelemetry v0.0.25 // indirect
	github.com/TykTechnologies/storage v1.3.1 // indirect
	github.com/TykTechnologies/structviewer v1.2.0 // indirect
	github.com/TykTechnologies/tyk-pump v1.14.1-rc1.0.20260424072310-bad4cd383b57 // indirect
	...
	github.com/ohler55/ojg v1.26.9 // indirect
	...
	github.com/warpstreamlabs/bento v1.16.2 // indirect
...
// Mirror of replace directives from the parent go.mod. They have to be
// repeated here because Go modules do not propagate `replace` directives
// down nested modules.
