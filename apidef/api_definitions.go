...
// For Toekn Exchange RFC 8693 https://www.rfc-editor.org/rfc/rfc8693.html
type TokenExchangeOptions struct {
	Enable       bool   `bson:"enable json:"enable,omitempty"`
	ClientID     string `bson:"client_id" json:"client_id,omitempty"`
	ClientSecret string `bson:"client_secret" json:"client_secret,omitempty"`

	// REQUIRED. A security token that represents the identity of the party on behalf
	// of whom the request is being made
	SubjectToken string `bson:"subject_token" json:"subject_token,omitempty"`

	// REQUIRED. An identifier, as described in Section 3, that indicates the type of 
