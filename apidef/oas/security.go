...
type JWT struct {
	...
	// JwkURIs contains a list of whitelisted JWK endpoints.
	//
	// Tyk classic API definition: `jwt_source`
	JwkURIs []apidef.JWK `bson:"jwkURIs,omitempty" json:"jwkURIs,omitempty"`
