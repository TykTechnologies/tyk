...
type CORS struct {
	...
	// OptionsPassthrough: If set to `true`, allow CORS OPTIONS preflight request to be proxied
	// directly to upstream, without authentication and rest of checks. This means that pre-flight
