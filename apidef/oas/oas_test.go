...
func TestOAS_ExtractTo_ResetAPIDefinition(t *testing.T) {
	...
	expectedFields := []string{
		...
		"APIDefinition.GlobalRateLimit.Smoothing.Enabled",
		"APIDefinition.GlobalRateLimit.Smoothing.Threshold",
		"APIDefinition.GlobalRateLimit.Smoothing.Trigger",
		"APIDefinition.GlobalRateLimit.Smoothing.Step",
		"APIDefinition.GlobalRateLimit.Smoothing.Delay",
