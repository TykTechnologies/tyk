...
func TestOAS_ExtractTo_ResetAPIDefinition(t *testing.T) {
	...
	expectedFields := []string{
		...
		"APIDefinition.JsonRpcVersion",
		"APIDefinition.ApplicationProtocol",
		...
		"APIDefinition.CustomMiddleware.Analytics.Disabled",
		"APIDefinition.CustomMiddleware.Analytics.Name",
		"APIDefinition.CustomMiddleware.Analytics.Path",
		"APIDefinition.CustomMiddleware.Analytics.RequireSession",
		"APIDefinition.CustomMiddleware.Analytics.RawBodyOnly",
