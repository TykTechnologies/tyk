...
func TestOAS_ExtractTo_ResetAPIDefinition(t *testing.T) {
	...
	expectedFields := []string{
		...
		"APIDefinition.VersionData.Versions[0].ExtendedPaths.TrackEndpoints[0].Disabled",
		...
		"APIDefinition.VersionData.Versions[0].ExtendedPaths.DoNotTrackEndpoints[0].Disabled",
