...
func (gw *Gateway) LoadDefinitionsFromRPCBackup() ([]*APISpec, error) {
	...
	if err != nil {
		return nil, errors.New("[RPC] --> RPC Backup recovery failed: " + err.Error())
	}
...
func (gw *Gateway) saveRPCDefinitionsBackup(list string) error {
	...
	if err != nil {
		return errors.New("--> RPC Backup save failed: " + err.Error())
	}
...
func (gw *Gateway) LoadPoliciesFromRPCBackup() (map[string]user.Policy, error) {
	...
	if err != nil {
		return nil, errors.New("[RPC] --> RPC Policy Backup recovery failed: " + err.Error())
	}
