...
func TestHandleFuncAdapter_HandleFunc(t *testing.T) {
	...
	streamMiddleware.defaultStreamManager.setAnalyticsFactory(factory)

	logger, _ := logrus.NewNullLogger()
	router := mux.NewRouter()
	testHandleFuncAdapter := handleFuncAdapter{
		streamID: "test",
		sm:       streamMiddleware.defaultStreamManager,
		mw:       &streamMiddleware,
		muxer:    router,
...
func (t *testStreamAnalyticsFactory) CreateRecorder(r *http.Request) StreamAnalyticsRecorder {
	t.recorder = &testStreamAnalyticsRecorder{}
	return t.recorder
}

func (t *testStreamAnalyticsFactory) CreateResponseWriter(w http.ResponseWriter, r *http.Request, streamID string, recorder StreamAnalyticsRecorder) http.ResponseWriter {
...
/*
type testStreamAnalyticsResponseWriter struct {

}

func (t *testStreamAnalyticsResponseWriter) Hijack() (net.Conn, *bufio.ReadWriter, error) {

}

func (t *testStreamAnalyticsResponseWriter) Flush() {

}

func (t *testStreamAnalyticsResponseWriter) Header() http.Header {

}

func (t *testStreamAnalyticsResponseWriter) Write(i []byte) (int, error) {

}

func (t *testStreamAnalyticsResponseWriter) WriteHeader(statusCode int) {
	t.actualStatusCode = statusCode
}
*/
