...
// signal. This test locks the create path to return 400 for custom IDs at
// or below MinTokenLength, while leaving autogenerated creates and longer
// custom IDs untouched.
func TestKeyHandler_RejectCustomKeyBelowMinTokenLength(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			keyID:    "shortid123",                          // 10 chars, below 32
			wantCode: http.StatusBadRequest,
		},
		{
			name:     "equal_to_min_token_length_rejected",
