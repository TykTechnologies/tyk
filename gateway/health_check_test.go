...
func TestGateway_liveCheckHandler_RedisDown(t *testing.T) {
	...
	// In release-5.8, this returns 503 Service Unavailable because Redis is a critical failure.
	// If TT-15507 was merged, it should return 200 OK.
	assert.Equal(t, http.StatusOK, w.Code, "Expected 200 OK even when Redis is down")
}
