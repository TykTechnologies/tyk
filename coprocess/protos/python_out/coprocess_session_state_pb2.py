...
_SESSIONSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='tags', full_name='coprocess.SessionState.tags', index=22,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='alias', full_name='coprocess.SessionState.alias', index=23,
