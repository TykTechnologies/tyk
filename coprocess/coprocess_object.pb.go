...
func file_coprocess_object_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_coprocess_object_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Object); i {
			case 0:
				return &v.state
			case 1:
		...
		file_coprocess_object_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Event); i {
			case 0:
				return &v.state
			case 1:
		...
		file_coprocess_object_proto_msgTypes[2].Exporter = func(v any, i int) any {
