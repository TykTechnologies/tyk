...
_MINIREQUESTOBJECT = _descriptor.Descriptor(
  ...
  nested_types=[_MINIREQUESTOBJECT_SETHEADERSENTRY, _MINIREQUESTOBJECT_PARAMSENTRY, _MINIREQUESTOBJECT_ADDPARAMSENTRY, _MINIREQUESTOBJECT_EXTENDEDPARAMSENTRY, ],
  enum_types=[
  ],
...
_MINIREQUESTOBJECT.fields_by_name['headers'].message_type = coprocess__common__pb2._HEADER
