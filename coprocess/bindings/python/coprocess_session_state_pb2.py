...
_SESSIONSTATE_BASICAUTHDATA = _descriptor.Descriptor(
  name='BasicAuthData',
  full_name='coprocess.SessionState.BasicAuthData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='password', full_name='coprocess.SessionState.BasicAuthData.password', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='hash', full_name='coprocess.SessionState.BasicAuthData.hash', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SESSIONSTATE_JWTDATA = _descriptor.Descriptor(
  name='JWTData',
  full_name='coprocess.SessionState.JWTData',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='secret', full_name='coprocess.SessionState.JWTData.secret', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SESSIONSTATE_MONITOR = _descriptor.Descriptor(
  name='Monitor',
  full_name='coprocess.SessionState.Monitor',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='trigger_limits', full_name='coprocess.SessionState.Monitor.trigger_limits', index=0,
...
_SESSIONSTATE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='orgID', full_name='coprocess.SessionState.orgID', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='oauth_clientID', full_name='coprocess.SessionState.oauth_clientID', index=11,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='apply_policyID', full_name='coprocess.SessionState.apply_policyID', index=18,
  ...
  nested_types=[_SESSIONSTATE_ACCESSRIGHTSENTRY, _SESSIONSTATE_OAUTHKEYSENTRY, _SESSIONSTATE_BASICAUTHDATA, _SESSIONSTATE_JWTDATA, _SESSIONSTATE_MONITOR, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_SESSIONSTATE_BASICAUTHDATA.containing_type = _SESSIONSTATE
_SESSIONSTATE_JWTDATA.containing_type = _SESSIONSTATE
_SESSIONSTATE_MONITOR.containing_type = _SESSIONSTATE
...
_SESSIONSTATE.fields_by_name['basic_auth_data'].message_type = _SESSIONSTATE_BASICAUTHDATA
_SESSIONSTATE.fields_by_name['jwt_data'].message_type = _SESSIONSTATE_JWTDATA
_SESSIONSTATE.fields_by_name['monitor'].message_type = _SESSIONSTATE_MONITOR
...
SessionState = _reflection.GeneratedProtocolMessageType('SessionState', (_message.Message,), dict(
  ...
  BasicAuthData = _reflection.GeneratedProtocolMessageType('BasicAuthData', (_message.Message,), dict(
    DESCRIPTOR = _SESSIONSTATE_BASICAUTHDATA,
    __module__ = 'coprocess_session_state_pb2'
    # @@protoc_insertion_point(class_scope:coprocess.SessionState.BasicAuthData)
    ))
  ,

  JWTData = _reflection.GeneratedProtocolMessageType('JWTData', (_message.Message,), dict(
    DESCRIPTOR = _SESSIONSTATE_JWTDATA,
    __module__ = 'coprocess_session_state_pb2'
    # @@protoc_insertion_point(class_scope:coprocess.SessionState.JWTData)
    ))
  ,

  Monitor = _reflection.GeneratedProtocolMessageType('Monitor', (_message.Message,), dict(
    DESCRIPTOR = _SESSIONSTATE_MONITOR,
    __module__ = 'coprocess_session_state_pb2'
    # @@protoc_insertion_point(class_scope:coprocess.SessionState.Monitor)
    ))
  ,
...
_sym_db.RegisterMessage(SessionState.BasicAuthData)
_sym_db.RegisterMessage(SessionState.JWTData)
_sym_db.RegisterMessage(SessionState.Monitor)
