...
// 	Nanos  int64
// 	Value  float64
// 	Status health.health.CompletionStatus
// }
...
// func (s *StatsDSink) EmitComplete(job string, status health.health.CompletionStatus, nanos int64, kvs map[string]string) {
// 	s.cmdChan <- statsdEmitCmd{Kind: statsdCmdKindComplete, Job: job, Status: status, Nanos: nanos}
// }
...
// func (s *StatsDSink) processComplete(job string, status health.health.CompletionStatus, nanos int64) {
// 	s.writeNanosToTimingBuf(nanos)
// 	statusString := status.String()
