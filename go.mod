...
require (
	...
	github.com/TykTechnologies/graphql-go-tools v1.6.2-0.20230703083914-e91d2b56f7d8
...
>>>>>>> 108c9462... [TT-9397] removed the replace for gorm and inherit the version from tyk-pump (#5342)
