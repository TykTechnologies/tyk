...
require (
	...
	github.com/TykTechnologies/opentelemetry v0.0.24
...
replace go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.60.0 => go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp v0.49.0
