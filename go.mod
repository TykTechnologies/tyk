...
require (
	...
	github.com/gernest/notify v0.0.1 // indirect
...
replace github.com/jensneuse/graphql-go-tools => github.com/TykTechnologies/graphql-go-tools v1.6.2-0.20210719163346-e69d4234c60e
