...
require (
	...
	github.com/hashicorp/vault v1.15.6 // indirect
	...
	github.com/hashicorp/vault-plugin-database-snowflake v0.9.1 // indirect
	github.com/hashicorp/vault-plugin-secrets-ad v0.16.2 // indirect
