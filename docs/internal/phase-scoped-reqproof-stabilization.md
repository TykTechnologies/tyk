...
2. Scope onboarding path:
   ...
   - Recent increments include `pkg/validator` custom-policy-ID validation,
     ...
     `internal/service/gojsonschema` and `internal/errors` facades, and
     `internal/errors` diagnostic classification. They reduce the visible scope
